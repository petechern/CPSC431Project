<?php
//Pretty much a copy of student upload, BUT needs to be tied to a specific course id
...
<form action="faculty_uploadassignment.php" method=post enctype="multipart/form-data">
