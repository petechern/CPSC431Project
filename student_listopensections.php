...
$sections = get_open_sections($mysqli, $cwid);

$pageTitle = "Student - View open sections";
        ...
        <div class="col-xs-12">
            ...
            <table class='table' >
              ...
              <?php while ($section = $sections->fetch_assoc()) { 
                ...
                '</td><td><a class="btn btn-primary" href="/student_enroll.php?cnum=' 
                . $section["Cnum"] . '&snum=' . $section["Snum"] . '">Enroll</a></td></tr>';
              }
              ?>
